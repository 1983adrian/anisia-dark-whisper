...
export function ChatInput({ onSendMessage, disabled, placeholder = "Scrie un mesaj..." }: ChatInputProps) {
  ...
  // Am scos verificarea de "disabled" aici pentru a permite trimiterea mereu
  const handleSubmit = () => {
      ...
      <div className="max-w-3xl mx-auto">
        {imagePreview && (
          <div className="mb-3 relative inline-block">
            ...
            <Button size="icon" variant="secondary" className="absolute -top-2 -right-2 h-6 w-6 rounded-full" onClick={removeImage}>
              <X className="h-3 w-3" />
            </Button>
          </div>
        )}
        ...
        <div className="relative flex items-end bg-[#2f2f2f] rounded-2xl border border-[#424242]">
          ...
          <Button
            ...
            className={cn(
              ...
              message.trim() || imageFile ? "bg-white text-black" : "bg-[#424242] text-muted-foreground"
            )}
